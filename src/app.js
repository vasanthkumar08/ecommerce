...
export const createApp = async () => {
  ...
  app.post("/graphql", cors(corsOptions), expressMiddleware(apolloServer, { context: createGraphQLContext }));

  app.use("/api/auth", authRateLimiter, authRoutes);
  app.use("/api/products", restRateLimiter, productRoutes);
  app.use("/api/cart", restRateLimiter, cartRoutes);
  app.use("/api/wishlist", restRateLimiter, wishlistRoutes);
  app.use("/api/orders", restRateLimiter, orderRoutes);
